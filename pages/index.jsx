    ...
    <>
      <Layout>
        <section
          ...
          className="flex sm:items-center mb-10 mt-5 md:mt-0"
        >
          <Container className="relative grid grid-cols-1 md:grid-cols-2">
            <div className="order-2 md:order-1">
              <img
                ...
                src="https://pandemuliada.github.io/images/dots.svg"
              />
              ...
              <p className="text-gray leading-relaxed mt-8 mb-10">
                I’m from Indonesia and working as freelance Front End Developer.
                I have been learning to code since I was 15 years old. I do
                enjoy programming because I love to solve problem and it fells
                amazing when I solve problem with programming. I’m looking
            ...
            <div className="relative flex justify-center md:justify-end order-1 md:order-2">
              <div className="relative md:mt-0 md:mr-20 mb-10 md:mb-0">
                <img
                  src="https://pandemuliada.github.io/images/rounded-rectangle.svg"
                ...
                />
                <img
                  src="https://pandemuliada.github.io/images/avatar.jpg"
                  className="hidden md:block mx-auto w-full rounded-md"
                />
                <img
                  src="https://pandemuliada.github.io/images/avatar-square.jpg"
